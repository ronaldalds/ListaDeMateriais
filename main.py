...
print(cabo.comprimento_ceo(poste.coordenada_pop_poste))
print(cabo.comprimento_reserva(poste.coordenada_pop_poste))
print(cabo.comprimento_cto_hub(poste.coordenada_pop_poste))
print(cabo.comprimento_cto(poste.coordenada_pop_poste))
print(cabo.comprimento_cto_futura(poste.coordenada_pop_poste))
